  ...
  return (
    <Layout page="subscribe" bgColor={subscriptionData.background_color}>
      ...
      <Helmet>
        ...
        <meta property="og:description" content="Zaupaj mi svoj elektronski naslov in postani prvi obveščenec, ako se na Blebetu manifestira frišna objava." />
        <meta name="description" content="Zaupaj mi svoj elektronski naslov in postani prvi obveščenec, ako se na Blebetu manifestira frišna objava." />
      </Helmet>
    </Layout>
  )
}